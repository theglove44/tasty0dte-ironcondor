...
from project_paths import PAPER_TRADES_CSV, SKIP_EVENTS_CSV

LOG_FILE = str(PAPER_TRADES_CSV)
SKIP_LOG_FILE = str(SKIP_EVENTS_CSV)
...
def log_skip_event(event) -> None:
    ...
    os.makedirs(os.path.dirname(SKIP_LOG_FILE) or ".", exist_ok=True)
