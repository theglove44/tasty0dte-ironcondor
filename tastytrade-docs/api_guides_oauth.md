<!-- Source: https://developer.tastytrade.com/api-guides/oauth/ -->
...
For these reasons, all tastytrade API users must use Oauth2 access tokens when interacting with the tastytrade API. Below are instructions on generating your own Oauth application, grant, and access tokens. Please also read through the [Auth Patterns](/api-overview/#auth-patterns) guide to learn how to provide access tokens as bearer tokens in the `Authorization` header of each API request.


## 1. Create an Oauth Application


Customers can create their own OAuth2 application on [my.tastytrade.com](https://my.tastytrade.com) by accessing the Manage tab > My Profile > API > OAuth Applications
...
See the OAuth2 spec for more information: [https://datatracker.ietf.org/doc/html/rfc6749#section-6](https://datatracker.ietf.org/doc/html/rfc6749#section-6).
...
If you're interested in becoming a trusted partner and allowing other tastytrade users to securely connect to your application, please contact [api.support@tastytrade.com](mailto:api.support@tastytrade.com). Once approved, users will be able to safely authorize your application through our secure OAuth flow, with full control over what permissions they grant.
...
tastytrade supports the [authorization code grant](https://datatracker.ietf.org/doc/html/rfc6749#section-4.1) OAuth2 flow. After tastytrade verifies and approves your application, you can direct users to authorize your application at `https://my.tastytrade.com/auth.html` (Sandbox: `https://cert-my.staging-tasty.works/auth.html`) with the following parameters:
...
See the OAuth2 spec for more information: [https://datatracker.ietf.org/doc/html/rfc6749#section-4.1.1](https://datatracker.ietf.org/doc/html/rfc6749#section-4.1.1).
...
See the OAuth2 spec for more information: [https://datatracker.ietf.org/doc/html/rfc6749#section-4.1.2](https://datatracker.ietf.org/doc/html/rfc6749#section-4.1.2).
...
See the OAuth2 spec for more information: [https://datatracker.ietf.org/doc/html/rfc6749#section-4.1.3](https://datatracker.ietf.org/doc/html/rfc6749#section-4.1.3).
...
See the OAuth2 spec for more information: [https://datatracker.ietf.org/doc/html/rfc6749#section-5.1](https://datatracker.ietf.org/doc/html/rfc6749#section-5.1).
...
In order to enable 2FA, a customer must navigate to [My Profile | Security](https://my.tastytrade.com/app.html#/manage/security) and enable either Authenticator App or SMS Authentication.
